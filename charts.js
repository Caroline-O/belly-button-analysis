...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {  
    ...
    var otu_ids= sampleVar.otu_ids
    var otu_labels = sampleVar.otu_labels
    var sample_values = sampleVar.sample_values
